...
class VibrantSubjectChart extends StatelessWidget {
  final List<Map<String, dynamic>> subjectData;

  const VibrantSubjectChart({super.key, required this.subjectData});
                    ...
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        if (value.toInt() < subjectData.length) {
                          ...
                          // Limit subject name length to prevent overflow
                          final subjectName = subject['name'].toString();
                          final displayName = subjectName.length > 10
